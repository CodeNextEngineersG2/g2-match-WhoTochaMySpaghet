 ...
 */
 function loadImages(){
  backImage= loadImage("assets/img/back.png");
   backImage= loadImage("assets/img/transition1.png");
    backImage= loadImage("assets/img/transition2.png");
     backImage= loadImage("assets/img/transition3.png");
  sunImage= loadImage("assets/img/sun.jpg");
  moonImage= loadImage("assets/img/moon.jpg");
  boltImage= loadImage("assets/img/bolt.jpg");
  cloudImage= loadImage("assets/img/cloud.jpg");
  heartImage= loadImage("assets/img/ heart.jpg");
  smileyImage= loadImage("assets/img/smiley.jpg");
 }
 ...
 */
function loadAnimations(){
  sunAnimation = loadAnimation(backImage, transitionImage1, transitionImage2, transitionImage3);
moonAnimation = loadAnimation(backImage, transitionImage1, transitionImage2, transitionImage3);
boltAnimation = loadAnimation(backImage, transitionImage1, transitionImage2, transitionImage3);
cloudAnimation = loadAnimation(backImage, transitionImage1, transitionImage2, transitionImage3);
heartAnimation = loadAnimation(backImage, transitionImage1, transitionImage2, transitionImage3);
smileyAnimation = loadAnimation(backImage, transitionImage1, transitionImage2, transitionImage3);
}
 ...
 */
function setup(){
  gameScreen=createCanvas(750,370);
 ...
 */
function addAnimations(){
  var animations = [sunAnimation, sunAnimation, moonAnimation, moonAnimation, boltAnimation, boltAnimation,cloudAnimation,cloudAnimation, heartAnimation,heartAnimation];
